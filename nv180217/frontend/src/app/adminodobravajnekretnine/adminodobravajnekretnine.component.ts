...
@Component({
  selector: 'app-adminodobravajnekretnine',
  templateUrl: './adminodobravajnekretnine.component.html',
  styleUrls: ['./adminodobravajnekretnine.component.css']
})
export class AdminodobravajnekretnineComponent implements OnInit {
