...
@Component({
  selector: 'app-adminugovoreneprodaje',
  templateUrl: './adminugovoreneprodaje.component.html',
  styleUrls: ['./adminugovoreneprodaje.component.css']
})
export class AdminugovoreneprodajeComponent implements OnInit {
