...
@Component({
  selector: 'app-agentnovanekretnina',
  templateUrl: './agentnovanekretnina.component.html',
  styleUrls: ['./agentnovanekretnina.component.css']
})
export class AgentnovanekretninaComponent implements OnInit {
